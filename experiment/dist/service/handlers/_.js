...
class BaseHandler {
    constructor(capabilities) {
        ...
        if (capabilities && capabilities.log) {
            this.logger = capabilities.log;
        }
    }
    // Handle GET request
    get(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("GET request received");
    ...
    post(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("POST request received");
    ...
    put(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("PUT request received");
    ...
    delete(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("DELETE request received");
    ...
    patch(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("PATCH request received");
    ...
    head(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("HEAD request received");
    ...
    options(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log("OPTIONS request received");
