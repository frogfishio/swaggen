...
const users_userid_1 = require("../handlers/users_userid");
const _1 = require("../handlers/_");
const swaggen_lambda_1 = require("@frogfish/swaggen-lambda"); // Import Lambda capability factory
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (!capabilitiesInstance) {
            capabilitiesInstance = (() => __awaiter(this, void 0, void 0, function* () {
                ...
                const awsFactory = new swaggen_lambda_1.LambdaCapabilityFactory();
...
function initializeHandler() {
    if (!handlerInstance) {
        handlerInstance = (() => __awaiter(this, void 0, void 0, function* () {
            ...
            return new users_userid_1.UsersUseridHandler(capabilities);
        }))();
    }
...
function handler(event, context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const internalReq = new _1.Request(event.httpMethod, event.headers, event.body ? JSON.parse(event.body) : undefined, event.path);
