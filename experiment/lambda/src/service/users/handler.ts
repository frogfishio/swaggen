...
import { CreateUserRequest, CreateUserResponse, ReadUserRequest, ReadUserResponse } from "./proxy";
...
export class UsersHandler extends BaseHandler {
  ...
  public async readUsers(req: Request): Promise<Response> {
    // Proxy method signature: readUser(request: ReadUserRequest): Promise<ReadUserResponse>;
  ...
  public async createUsers(req: Request): Promise<Response> {
    // Proxy method signature: createUser(request: CreateUserRequest): Promise<CreateUserResponse>;
