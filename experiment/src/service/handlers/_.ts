...
import { Capabilities, Log } from "../capabilities/capabilities"; // Import capabilities and logger types
...
export class BaseHandler implements Handler {
  ...
  protected logger: Log | null = null;
