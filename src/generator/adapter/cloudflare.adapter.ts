...
export class CloudflareAdapterGenerator extends BaseGenerator {
  ...
  public async generate(
    ...
    // Render the template
    const templatePath = this.getTemplatePath("cloudflare.ejs");
    ...
    console.log(`Created Cloudflare adapter: ${adapterFilePath}`);
  }
